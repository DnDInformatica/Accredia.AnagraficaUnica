            ...
            CancellationToken cancellationToken) =>
        {
            ...
            try
            {
                ...
                var personaCreata = await context.Persone
                    ...
                    .FirstAsync(p => p.PersonaId == persona.PersonaId, cancellationToken);

                var response = new PersonaResponse
                {
                    PersonaId = personaCreata.PersonaId,
                    ...
                    EntitaAziendaleName = personaCreata.EntitaAziendale?.Denominazione,
                ...
                return Results.Created($"/api/persone/{persona.PersonaId}", response);
            }
            catch (Exception ex)
            {
