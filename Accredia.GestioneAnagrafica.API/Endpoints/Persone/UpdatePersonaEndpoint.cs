    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            var persona = await context.Persone
                .FirstOrDefaultAsync(p => p.EntitaAziendaleId == id && p.DataCancellazione == null, cancellationToken);
            ...
            try
            {
                ...
                var personaAggiornata = await context.Persone
                    ...
                    .FirstAsync(p => p.EntitaAziendaleId == id, cancellationToken);
