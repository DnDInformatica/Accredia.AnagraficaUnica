    ...
    public class PersoneDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Persona>(entity =>
            {
                ...
                // La PK EntitaAziendaleId mappa alla colonna EntitaAziendaleId
                entity.Property(e => e.EntitaAziendaleId)
                    .HasColumnName("EntitaAziendaleId")
                    .ValueGeneratedNever(); // Non è IDENTITY, viene dalla tabella EntitaAziendale
                ...
                // Relationship con EntitaAziendale (1:1, EntitaAziendaleId è FK verso EntitaAziendaleId)
                entity.HasOne(e => e.EntitaAziendale)
                    .WithMany(ea => ea.Persone)
                    .HasForeignKey(e => e.EntitaAziendaleId) // EntitaAziendaleId è la FK
