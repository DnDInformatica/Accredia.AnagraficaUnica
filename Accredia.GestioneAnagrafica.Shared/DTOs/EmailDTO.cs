...
namespace Accredia.GestioneAnagrafica.Shared.DTOs
{
    ...
    public class CreatePersonaRequest
    {
        ...
        /// <summary>
        /// Lista degli indirizzi associati alla persona
        /// </summary>
        [JsonPropertyName("indirizzi")]
        public List<PersonaIndirizzoDTO.Create>? Indirizzi { get; set; }

        /// <summary>
        /// Lista delle email associate alla persona
        /// </summary>
        [JsonPropertyName("email")]
        public List<Accredia.GestioneAnagrafica.API.DTOs.EmailDTO.Create>? Email { get; set; }
    }
    ...
    public class UpdatePersonaRequest : CreatePersonaRequest
    {
        ...
        /// <summary>
        /// Email aggiornabili collegate alla persona
        /// </summary>
        [JsonPropertyName("email")]
        public new List<Accredia.GestioneAnagrafica.API.DTOs.EmailDTO.Update>? Email { get; set; }
    }
    ...
    public class PersonaResponse
    {
        ...
        /// <summary>
        /// Elenco delle email associate alla persona
        /// </summary>
        [JsonPropertyName("email")]
        public List<Accredia.GestioneAnagrafica.API.DTOs.EmailDTO.Response>? Email { get; set; }
    }
}
